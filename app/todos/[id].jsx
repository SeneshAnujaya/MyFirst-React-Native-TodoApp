...
export default function EditScreen() {
  ...
  return (
    ...
    <View style={styles.inputContainer}>
      <TextInput style={styles.input} maxLength={30} placeholder="Edit todo" placeholderTextColor="gray" value={todo?.title || ''} onChangeText={(text) => setTodo(prev => ({...prev, title: text}))}/>
      <Pressable
          onPress={() =>
    ...
    <View style={styles.inputContainer}>
      <Pressable onPress={handelSave} style={styles.saveButton}>
